...
lapply(list(r2019_0204,r2020_0204),
       function(x){
          writeRaster(x,
                      gsub('\\.','_',file.path('output', names(x))),
                      format = "GTiff",
...
lapply(list(Anomaly_Cargo, Anomaly_Fishing, Anomaly_Passenger,
...
B3NM_edited <- st_read('data/B3NM_edited.gpkg')
B12NM_edited <- st_read('data/B12NM_edited.gpkg')
